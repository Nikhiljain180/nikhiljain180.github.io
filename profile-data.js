...
window.PROFILE = {
  ...
  about: {
    ...
    paragraphs: [
      ...
      "I led the adoption of AI SDKs and workflow automation across teams — automating 5,000+ Generative UI components and streamlining workflows end to end. My work spans the full AI lifecycle: ideation, architecture, deployment, and monitoring — with measurable productivity gains, cost savings, and better user experiences.",
